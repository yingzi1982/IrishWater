...
gmt grd2cpt $grd -CGMT_rainbow.cpt -L-50/-20 -E100 > $cpt
...
echo 1.40 $y_dot | gmt psxy -R -J -Sd0.04i -Gblue  -N -Wthinner,black -O -K >> $ps
...
echo 3.15 $y_dot | gmt psxy -R -J -St0.04i -Gblue  -N -Wthinner,black -O -K >> $ps
