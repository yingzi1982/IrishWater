...
colorbar_width=`echo "$width*2/3" | bc -l`
colorbar_height=0.16
colorbar_vertical_offset=-0.6
...
gmt psscale -DjCB+w$colorbar_width\i/$colorbar_height\i+o0/$colorbar_vertical_offset\i+h -C$cpt -Baf -R -J -O >> $ps
