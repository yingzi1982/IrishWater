...
awk '{print $1, $2}' $backupfolder\sourceOctavePSD | gmt psxy -J$projection -R$region -Bxa8f4+l"Frequency (Hz)" -Bya20f10+l"(dB/Hz)" -Sb0.1 -Ggray -Wthinner,black -Y$offset -O -K >> $ps
