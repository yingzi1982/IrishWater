...
gmt psbasemap -R$region -J$projection -Bxa4.0f2.0+l"Easting (km) " -Bya2.0f1.0+l"Northing (km)" -Y4\i -K > $ps
...
gmt psbasemap -R$region -J$projection -Bxa4.0f2.0+l"Easting (km) " -Bya2.0f1.0+l"Northing (km)" -Y$offset\i -O -K >> $ps
